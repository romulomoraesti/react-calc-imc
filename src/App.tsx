    ...
    <div className={styles.main}>
      ...
      <div className={styles.container}>
        <div className={styles.leftSide}>
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque dolor voluptas temporibus voluptatem voluptates molestias omnis maiores necessitatibus aliquam est</p>
